            ...
            <div className='flex items-center gap-2 cursor-pointer group relative'>
                ...
                <div className='absolute top-0 right-0 pt-14 text-base font-medium hidden group-hover:block'>
                    <div className='min-w-48 bg-stone-100 rounded p-4 flex flex-col gap-4'>
                        <p onClick={()=>{
                            navigate('/my-profile')
                        }} className='hover:text-gray-400 cursor-pointer font-light'>My Profile</p>
                        <p onClick={()=>{
                            navigate('/my-appointments')
                        }} className='hover:text-gray-400 cursor-pointer font-light'>My Appointments</p>
                        <p onClick={()=>{
                            setToken(false)
                        }} className='hover:text-gray-400 cursor-pointer font-light'>Logout</p>
                    </div>
                </div>
            </div>:
